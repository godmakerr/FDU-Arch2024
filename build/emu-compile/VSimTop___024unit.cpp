...
extern "C" void v_difftest_ArchEvent(char coreid, int intrNo, int cause, long long exceptionPC);

VL_INLINE_OPT void VSimTop___024unit____Vdpiimwrap_v_difftest_ArchEvent_TOP____024unit(CData/*7:0*/ coreid, IData/*31:0*/ intrNo, IData/*31:0*/ cause, QData/*63:0*/ exceptionPC) {
...
VL_INLINE_OPT void VSimTop___024unit____Vdpiimwrap_get_switch_TOP____024unit(IData/*31:0*/ &get_switch__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VSimTop___024unit____Vdpiimwrap_get_switch_TOP____024unit\n"); );
    // Body
